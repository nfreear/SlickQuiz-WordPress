            ...
            <tbody>
                <tr valign="top">
                    ...
                    <td>
                        ...
                        <br /><small><em>Enabling filters allows for the inclusion of shortcodes and other plugin hooks.<br/>
                                        You can disable this if you're seeing strange output in your quiz.<br/>
                                        Note: disabling filters presents a security risk &ndash; disable with caution.</em></small>
                    </td>
                </tr>
            </tbody>
        </table>
